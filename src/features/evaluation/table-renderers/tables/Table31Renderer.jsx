/**
 * Table31Renderer - Renderer spécifique pour la table C1T31 (Lésion de pression)
 * 
 * Table avec RadioGroup + TextInput conditionnel.
 * 
 * Plan ÉTAPE 26 - Table avec champ conditionnel
 */
...
export default Table31Renderer;
