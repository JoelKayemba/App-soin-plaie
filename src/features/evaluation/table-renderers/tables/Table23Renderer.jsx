/**
 * Table23Renderer - Renderer spécifique pour la table C1T23 (Tissu de granulation - BWAT)
 * 
 * Plan ÉTAPE 13 - Table BWAT simple
 */
...
export default Table23Renderer;
