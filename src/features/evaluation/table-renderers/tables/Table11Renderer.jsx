/**
 * Table11Renderer - Renderer spécifique pour la table C1T11 (Histoire de la plaie)
 * 
 * Table avec helpers (burn_stages, pressure_stages), badges d'âge calculés,
 * et alerts spécialisées (lymphedema, neoplasia).
 * 
 * Plan ÉTAPE 31 - Table avec helpers et alerts
 */
...
export default Table11Renderer;
