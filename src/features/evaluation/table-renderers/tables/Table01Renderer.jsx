/**
 * Table01Renderer - Renderer spécifique pour la table C1T01 (Données de base)
 * 
 * Table avec DateTextInput spécial pour la date de naissance (format AAAA-MM-JJ).
 * Utilise ElementRenderer pour le rendu générique, mais gère le cas spécial DateTextInput.
 * 
 * Plan ÉTAPE 14 - Table avec DateTextInput spécial
 */
...
const Table01Renderer = ({
  ...
  // Note: ElementRenderer gère déjà le cas DateTextInput pour les dates de naissance
  // (détecte via element.id.includes('birth') ou element.label.includes('naissance'))
...
export default Table01Renderer;
