/**
 * Table21Renderer - Renderer spécifique pour la table C1T21 (Composition lit plaie)
 * 
 * Table avec NumericInput pour pourcentages.
 * 
 * Plan ÉTAPE 21 - Table avec NumericInput pourcentages
 */
...
export default Table21Renderer;
