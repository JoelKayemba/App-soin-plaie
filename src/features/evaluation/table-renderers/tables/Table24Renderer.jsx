/**
 * Table24Renderer - Renderer spécifique pour la table C1T24 (Épithéliatisation)
 * 
 * Table avec alerte biofilm conditionnelle (si épithélium ≠ 100%).
 * 
 * Plan ÉTAPE 33 - Table avec alerte biofilm
 */
...
export default Table24Renderer;
