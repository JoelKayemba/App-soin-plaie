/**
 * Table10Renderer - Renderer spécifique pour la table C1T10 (Niveau de soins)
 * 
 * Table simple avec un élément de sélection unique (RadioGroup) pour déterminer
 * le niveau de soins requis. Utilise ElementRenderer pour le rendu générique.
 */
...
const Table10Renderer = ({
  ...
  return (
    <TView style={styles.contentContainer}>
      {/* Affichage du titre et des instructions en haut au centre */}
...
export default Table10Renderer;
