/**
 * Table08Renderer - Renderer spécifique pour la table C1T08 (Psychosocial)
 * 
 * Plan ÉTAPE 19 - Table avec SimpleCheckbox
 */
...
export default Table08Renderer;
