/**
 * Table05Renderer - Renderer spécifique pour la table C1T05 (Nutrition)
 * 
 * Plan ÉTAPE 17 - Table avec SimpleCheckbox
 */
...
export default Table05Renderer;
