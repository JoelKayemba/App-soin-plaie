const colors = {
  light: {
    ...
    surface: '#D5DEEF',        // cartes, zones secondaires
    ...
    text: '#395886',           // texte principal
    textSecondary: '#6B7280',  // texte secondaire
    textTertiary: '#9CA3AF',  // texte tertiaire
    textLight: '#F0F3FA',      // texte clair (sur primary)
    border: '#D5DEEF',         // bordures
  ...
  dark: {
    ...
    text: '#F0F3FA',           // texte principal
    textSecondary: '#9CA3AF', // texte secondaire
    textTertiary: '#6B7280',   // texte tertiaire
    textLight: '#1C1F26',      // texte foncé (sur boutons clairs)
    border: '#395886',         // séparateurs discrets
